...
{
	import de.axelspringer.videoplayer.vast.parser.base.Parser;
	import de.axelspringer.videoplayer.vast.parser.base.VAST2InLineElement;
	import de.axelspringer.videoplayer.vast.parser.base.VAST2Time;
	...
	public dynamic class VAST2Parser extends Parser 
	{
		...
		*/
		...
		{
			return _trackingData.extensionsArray;
		}
		...
		{
			return _trackingData.surveyArray;
		}
		...
		public function get adTagVASTDuration() : VAST2Time 
		{
			...
			var result:VAST2Time = new VAST2Time();
			if( _LinearAdsArray != null && _LinearAdsArray[0] != null )
			{
				result = _LinearAdsArray[0].videoDuration;
			}
		...
		public function get adParameters() : String 
		{
			...
			if( _LinearAdsArray != null && _LinearAdsArray[0] != null )
			{
				result = _LinearAdsArray[0].AdParameters;
			}
		...
		{
			if (_LinearAdsArray != null && _LinearAdsArray.length > 0)
		...
		{
			if (_NonLinearAdsArray[0] != null && _NonLinearAdsArray.length > 0)
		...
		{
			return _LinearAdsArray[0] == null ? null : _LinearAdsArray[0].MediaFiles;
		}
