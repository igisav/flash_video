    ...
    public class VideoplayerMain extends Sprite
    {
        ...
        protected function init():void {
            ...
            catch (e:Error)
            {
                ...
                trace("ExternalInterface error, url von " + this.loaderInfo.url);
            }
            ...
            trace("BildTvDefines.url = " + BildTvDefines.url + " js URL:" + this.loaderInfo.parameters.jsurl);
            ...
            try
            {
                ...
                trace("check " + BildTvDefines.urlLong + " for player version");
            }
            catch (e:Error)
            {
                trace(this + "Kein Scriptaccess!");
            }
        ...
        protected function checkDebugSetting():void {
            ...
            try
            {
                ...
                {
                    trace(this + " set logLevelFilter because of url parameter");
                }
                else
                {
                    if (this.loaderInfo.parameters.debug == "1" || this.loaderInfo.parameters.debug == "true")
                    {
                        trace(this + " set logLevelFilter because of flashvar");
                    }
                }
            }
            catch (error:Error)
